						...
						if ( has_action( 'woocommerce_account_downloads_column_' . $column_id ) ) {
							...
							switch ( $column_id ) {
								case 'download-product':
									...
									break;
								case 'download-file':
									echo '<a href="' . esc_url( $download['download_url'] ) . '" class="woocommerce-MyAccount-downloads-file botao afirmacao" title="'.esc_html( $download['download_name'] ).'"><i class="far fa-long-arrow-down" style="font-size: 1.2em; line-height: 0; position: relative; bottom: -1px;" aria-hidden="true"></i> Baixar</a>';
									break;
