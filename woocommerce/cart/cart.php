			...
			<tbody>
				...
				<tr>
					<td colspan="6" class="actions">
						...
						<a href="<?php echo esc_url( wc_get_cart_url() ); ?>?limpar-carrinho" class="botao-liso mr-20px">limpar carrinho <i class="fa-solid fa-delete-left"></i></a>
...
<div class="colmenor dir">
	<?php do_action( 'woocommerce_cart_collaterals', 'woocommerce_cart_totals' ); ?>
