					...
					if ( has_action( 'woocommerce_email_downloads_column_' . $column_id ) ) {
						...
						switch ( $column_id ) {
							...
							case 'download-file':
								...
								<?php */
                                ?><a style="text-decoration:none" href="<?php echo esc_url( $download['download_url'] ); ?>" class="woocommerce-MyAccount-downloads-file button alt"><strong style="text-transform:uppercase;">&#10142; clique aqui</strong></a><?php
								break;
