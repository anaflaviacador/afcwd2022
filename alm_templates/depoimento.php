...
<div class="cliente">
    <div class="cliente-container w-clearfix">
        <img src="<?php echo $urlTema; ?>/assets/images/aspas.svg" aria-hidden="true" alt="Grafismo" class="ico-aspas">
        ...
        <div class="hide-mobile">
            <?php if ($projeto || $site) : ?>
                <div class="cliente-links">
                    ...
                    <?php endif; ?>
                    <?php if ($site) : ?>
                        <a href="<?php echo esc_url($site); ?>" target="_blank" rel="noopener" class="botao verde">ver online <i class="fa-light fa-arrow-up-right-from-square bt-seta"></i></a>
                    <?php endif; ?>
                </div>
        ...
        <div class="hide-desk">
            <?php if ($projeto || $site) : ?>
                <div class="cliente-links">
                    ...
                    <?php endif; ?>
                    <?php if ($site) : ?>
                        <a href="<?php echo esc_url($site); ?>" target="_blank" rel="noopener" class="botao-liso verde">ver online <i class="fa-light fa-arrow-up-right-from-square bt-seta"></i></a>
                    <?php endif; ?>
                </div>
            <?php elseif (class_exists('Woocommerce') && $produto) : ?>
                <div class="cliente-links">
