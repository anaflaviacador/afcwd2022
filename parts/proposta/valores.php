...
<section class="container pb-4em">
 ...
 Pagamento via Paypal, com acréscimo de 6,5% (por fatura) devido às tarifas internacionais da plataforma. <em>Obs: Podem ocorrer outras cobranças referentes à sua prestadora do cartão de crédito devido ao pagamento internacional.</em>
                <?php else : ?>
