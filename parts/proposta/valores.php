...
<section class="container pb-4em">
 ...
 Pagamento via Paypal (fatura em moeda BRL) com acréscimo de 5%.<br> <em class="texto-menor">🚨 Podem ocorrer outras cobranças pela prestadora do seu cartão de crédito devido à transação internacional.</em>
                <?php else : ?>
