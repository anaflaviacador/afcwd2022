...
<div class="topbar">
    <div class="container flexb-justify-space-between">
        <ul role="list" class="toplinks">
            <li class="toplinks-li"><img src="<?php echo $urlTema;?>/assets/images/house-chimney-solid.svg" loading="lazy" width="14" alt="" aria-hidden="true" class="toplinks-ico">
        ...
        <div id="abre-nav-mobile" data-w-id="eb49a3b3-d711-b197-e4ba-f681ade60438" class="bt-menu-mob">
            ...
            <div class="bt-menu-fechar"><?php esc_html_e( 'Fechar', 'afcwd2022' ); ?></div><img src="<?php echo $urlTema;?>/assets/images/ico-menu.svg" loading="lazy" alt=""
                class="bt-menu-mob-ico"><img src="<?php echo $urlTema;?>/assets/images/ico-menu-close.svg" loading="lazy" alt=""
